...
class Capacitor(CircuitComponent):
    ...
    def __init__(self, is_polar=False, **kwargs):
...
class Inductor(CircuitComponent):
    def generate_points(self):
        ...
        arc1 = Arc(start_angle=TAU/2, angle=-TAU/2,radius=0.125)
        arc1.shift(0.25*LEFT)
        arc2 = Arc(start_angle=TAU/2, angle=-TAU/2,radius=0.125)
        arc3 = Arc(start_angle=TAU/2, angle=-TAU/2,radius=0.125)
